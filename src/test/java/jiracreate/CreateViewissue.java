...
public class CreateViewissue {
	static String chromepath =System.getProperty("user.dir")+"\\resources\\chromedriver.exe"; //to get path for chrome driver static to access by all function
